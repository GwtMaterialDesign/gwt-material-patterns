...
var __gwtModuleFunction = $wnd.GwtMaterialPatterns;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.GwtMaterialPatterns=");
    idx += (13 + "GwtMaterialPatterns".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=GwtMaterialPatterns-0.js
