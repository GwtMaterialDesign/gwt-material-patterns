function GwtMaterialPatterns(){
  ...
  GwtMaterialPatterns.__sendStats = sendStats;
  GwtMaterialPatterns.__moduleName = $intern_4;
  GwtMaterialPatterns.__errFn = null;
  GwtMaterialPatterns.__moduleBase = $intern_6;
  GwtMaterialPatterns.__softPermutationId = $intern_7;
  GwtMaterialPatterns.__computePropValue = null;
  GwtMaterialPatterns.__getPropMap = null;
  GwtMaterialPatterns.__installRunAsyncCode = function(){
  }
  ;
  GwtMaterialPatterns.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  GwtMaterialPatterns.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  GwtMaterialPatterns.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  GwtMaterialPatterns.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[GwtMaterialPatterns.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (GwtMaterialPatterns.__errFn) {
        script.onerror = function(){
          GwtMaterialPatterns.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  GwtMaterialPatterns.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  GwtMaterialPatterns.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    GwtMaterialPatterns.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return GwtMaterialPatterns.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    GwtMaterialPatterns.__getPropMap = function(){
      var result = {};
    ...
    ;
    GwtMaterialPatterns.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = GwtMaterialPatterns.__getPropMap;
    ...
    GwtMaterialPatterns.__softPermutationId = softPermutationId;
  ...
  function loadExternalStylesheets(){
    ...
    sendStats($intern_58, $intern_65);
  }

  processMetas();
  GwtMaterialPatterns.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = GwtMaterialPatterns.__moduleBase;
